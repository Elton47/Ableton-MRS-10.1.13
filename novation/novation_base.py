...
class NovationBase(IdentifiableControlSurface):
    ...
    def _create_session(self):
        ...
        self._session_navigation = SessionNavigationComponent(name='Session_Navigation', is_enabled=False, session_ring=self._session_ring, layer=self._create_session_navigation_layer())
