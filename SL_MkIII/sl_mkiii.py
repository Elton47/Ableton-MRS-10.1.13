...
class SLMkIII(IdentifiableControlSurface):
    ...
    def _create_modes(self):
        ...
        self._encoder_modes.add_mode('devices', [
         ...
         LayerMode(self._device_navigation, Layer(select_buttons='pads_flattened', device_color_fields='color_field_lines_0_1_flattened', device_name_display_1='text_display_line_0', device_name_display_2='text_display_line_2', device_bank_name_display_1='text_display_line_1', device_bank_name_display_2='text_display_line_3', device_selection_fields='selection_field_lines_0_1_flattened', selected_device_name_display='center_display_1')),
         ...
         LayerMode(self._device, Layer(prev_bank_button='display_up_button', next_bank_button='display_down_button')),
         AddLayerMode(self._mixer, Layer(selected_track_color_field='center_color_field', selected_track_name_display='center_display_1')),
         AddLayerMode(self._background, Layer(center_display_2='center_display_2', scene_launch_buttons='scene_launch_buttons', encoders='encoders')),
         AddLayerMode(self._actions, Layer(actions_display='text_display_line_5_with_shift', actions_selection_fields='selection_field_line_2_with_shift'))])
        self._encoder_modes.add_mode('pan', [
         partial(self._switch_display_layout, sysex.KNOB_SCREEN_LAYOUT_BYTE),
         AddLayerMode(self._encoder_modes, Layer(mode_display=self._elements.text_display_line_3, mode_color_fields=self._elements.color_field_line_2, mode_selection_fields=self._elements.selection_field_line_1, selected_mode_color_field='center_color_field')),
         AddLayerMode(self._mixer, Layer(pan_controls='encoders', track_names_display='text_display_line_0', pan_value_display='text_display_line_1', pan_encoder_color_fields='encoder_color_fields', track_color_fields='color_field_line_0', mixer_display='center_display_1', pan_display='center_display_2')),
         AddLayerMode(self._background, Layer(display_up_button='display_up_button', display_down_button='display_down_button')),
        ...
        self._main_modes.add_mode('device_control', [
         partial(self._switch_display_layout, sysex.KNOB_SCREEN_LAYOUT_BYTE),
         AddLayerMode(self._mixer, Layer(track_select_buttons='select_buttons', track_names_display='text_display_line_3', track_color_fields='color_field_line_2', track_selection_fields='selection_field_line_1', selected_track_color_field='center_color_field')),
         LayerMode(self._device_parameters, Layer(parameter_controls='encoders', name_display_line='text_display_line_0', value_display_line='text_display_line_1', parameter_color_fields='color_field_line_0', encoder_color_fields='encoder_color_fields')),
         LayerMode(self._session_navigation, Layer(up_button='up_button', down_button='down_button')),
         LayerMode(self._device, Layer(prev_bank_button='display_up_button', next_bank_button='display_down_button')),
         LayerMode(self._device_navigation, Layer(selected_device_name_display='center_display_1', selected_device_bank_name_display='center_display_2')),
         AddLayerMode(self._actions, Layer(actions_display='text_display_line_3_with_shift', actions_selection_fields='selection_field_line_1_with_shift'))])
        self._main_modes.add_mode('options', [
         self._encoder_modes,
         LayerMode(self._encoder_modes, Layer(devices_button='select_buttons_raw[0]', pan_button='select_buttons_raw[1]', sends_button='select_buttons_raw[2]')),
         SetAttributeMode(self._encoder_modes, 'selected_mode', 'devices'),
         AddLayerMode(self._background, Layer(select_button_3='select_buttons_raw[3]', select_button_4='select_buttons_raw[4]', select_button_5='select_buttons_raw[5]', select_button_6='select_buttons_raw[6]', select_button_7='select_buttons_raw[7]'))], behaviour=ReenterBehaviour(on_reenter=partial(set_main_mode, 'device_control')))
        self._main_modes.add_mode('grid', [
         ...
         AddLayerMode(self._actions, Layer(actions_display='text_display_line_3_with_shift', actions_selection_fields='selection_field_line_1_with_shift'))], behaviour=ReenterBehaviour(on_reenter=partial(set_main_mode, 'device_control')))
