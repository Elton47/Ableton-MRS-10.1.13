...
class Elements(LaunchpadElements):
    ...
    def __init__(self, *a, **k):
        ...
        self.track_select_buttons_raw = [ create_button(index + 101, ('Track_Select_Button_{}').format(index)) for index in xrange(SESSION_WIDTH)
                                        ]
        self.track_select_buttons = ButtonMatrixElement(rows=[
         self.track_select_buttons_raw], name='Track_Select_Buttons')
        ...
        self.print_to_clip_element = SysexElement(name='Print_To_Clip_Element', sysex_identifier=print_to_clip_identifier, send_message_generator=lambda v: print_to_clip_identifier + (
         v, sysex.SYSEX_END_BYTE))
        self.print_to_clip_enabler_element = SysexElement(name='Print_To_Clip_Enabler', send_message_generator=lambda v: sysex.STD_MSG_HEADER + (
        ...
        self.stop_fader_element = SysexElement(name='Stop_Fader_Element', send_message_generator=self._stop_fader_message_generator, sysex_identifier=sysex.STD_MSG_HEADER + (
