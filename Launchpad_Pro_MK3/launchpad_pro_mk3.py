...
class Launchpad_Pro_MK3(InstrumentControlMixin, NovationBase):
    ...
    def _create_clip_actions(self):
        self._clip_actions = ClipActionsComponent(name='Clip_Actions', is_enabled=False, layer=Layer(delete_button='clear_button', duplicate_button='duplicate_button', quantize_button='quantize_button', double_loop_button='duplicate_button_with_shift'))
    ...
    def _create_drum_group(self):
        self._drum_group = DrumGroupComponent(name='Drum_Group', is_enabled=False, translation_channel=DRUM_FEEDBACK_CHANNEL, layer=Layer(matrix='drum_pads'))
        self._drum_group.set_enabled(True)

    def _create_device_parameters(self):
        self._device_parameters = SimpleDeviceParameterComponent(name='Device_Parameters', is_enabled=False, layer=Layer(parameter_controls='device_button_faders', static_color_controls='device_button_fader_color_elements', stop_fader_control='stop_fader_element'), static_color_value=Rgb.DARK_BLUE.midi_value)
    ...
    def _create_mixer_modes(self):
        ...
        def add_track_select_button_mode(name, control=None, component=self._mixer):
            ...
            self._mixer_modes.add_mode(name, (
             AddLayerMode(component, Layer(**control_dict)), restore_main_layout), behaviour=ReenterBehaviour(on_reenter=reselect_track_select_mode))
    ...
    def _create_session_modes(self):
        ...
        self._session_modes.add_mode('overview', (
         ...
         AddLayerMode(self._session_navigation, Layer(page_up_button='up_button', page_down_button='down_button', page_left_button='left_button', page_right_button='right_button'))), behaviour=MomentaryBehaviour())
    ...
    def _create_main_modes(self):
        ...
        suppressed_arrow_button_mode = (
         AddLayerMode(self._background, Layer(left_button='left_button', right_button='right_button', up_button='up_button', down_button='down_button')),)
        ...
        self._main_modes.add_mode('note', (
         AddLayerMode(self._drum_group, Layer(scroll_up_button='left_button', scroll_down_button='right_button', scroll_page_up_button='up_button', scroll_page_down_button='down_button')),
         self._clip_actions))
